...
/*
this solution forgets the last segment of the continents: from the last vertex to the first vertex
*/

public class Egor_NoLastSegmentInContinents {
	...
	public static void main(String[] args) throws IOException{
	  ...
	  BufferedReader reader=new BufferedReader(new InputStreamReader(System.in));
	    ...
	    for(int i=0;i<nContinents;i++){
	    	coastline.addAll(readPolygone(reader, false));//<--- here we go: no closing
	    }
