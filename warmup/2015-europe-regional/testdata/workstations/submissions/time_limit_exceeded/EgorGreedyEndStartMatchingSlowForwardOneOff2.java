 ...
 *          
 *          
 *  Problem: the binary search returns an element with value from, but not the first element with value from, thus we dont see the first n of them...
 */
public class EgorGreedyEndStartMatchingSlowForwardOneOff2 {
    ...
    static class LookUp{
    	...
    	boolean removeBiggestInTheRange(int from, int to){
    		int index=Arrays.binarySearch(vals, from);// <------------------ "-1" needed
    		if(index<0)
