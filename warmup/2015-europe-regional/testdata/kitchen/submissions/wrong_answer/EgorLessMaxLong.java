...
/*
should fail if result is between 10^18 and Long.MAX_VALUE

*/

public class EgorLessMaxLong {
	...
	public static void main(String[] args) throws IOException {
		 ...
		 if(result==Long.MAX_VALUE)//<--- here we go, there may be something between 10^18 and max_value
